...
public class _wordyStub extends org.omg.CORBA.portable.ObjectImpl implements wordy
{
  ...
  public void login (String username, String password) throws checkLogin, notFound, invalid, validatedLogin
  {
            ...
            try {
                ...
                String _id = $ex.getId ();
                if (_id.equals ("IDL:corba/checkLogin:1.0"))
                    throw checkLoginHelper.read ($in);
                else if (_id.equals ("IDL:corba/notFound:1.0"))
                    throw notFoundHelper.read ($in);
                else if (_id.equals ("IDL:corba/invalid:1.0"))
                    throw invalidHelper.read ($in);
                else if (_id.equals ("IDL:corba/validatedLogin:1.0"))
  ...
  public boolean joinLobby (String playerName) throws Client_Java.corba.GameException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:corba/GameException:1.0"))
                    throw Client_Java.corba.GameExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public String getWinner () throws isSameLength
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:corba/isSameLength:1.0"))
